...
class LoadstarSensorsInterface():
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'write_timeout' not in kwargs:
            kwargs.update({'timeout': self._WRITE_TIMEOUT})
    ...
    def get_model(self):
        """Sensor device model."""
        response = self._send_request_get_response(b'model')
    ...
    def _send_request_get_response(self, request, use_readline=True):
        ...
        self._serial.write(request + self._REQUEST_EOL)
